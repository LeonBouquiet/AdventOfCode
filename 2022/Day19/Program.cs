...
namespace Day19
{
	...
	public class GameState
	{
		...
		public IEnumerable<GameState> GenerateChildStates(Blueprint blueprint)
		{
			...
			foreach (int materialType in new[] { MaterialType.Ore, MaterialType.Clay, MaterialType.Obsidian, MaterialType.Geode })
			{
				do
				{
					...
					if (child.Materials.IsNonNegative == false)
						break;	//Couldn't afford this MaterialType yet, skip it.
			...
			//Materials = parent.Materials + Robots;
